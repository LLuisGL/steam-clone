<div class= "bg-[#181A21] flex flex-col items-center justify-center">
    <div class= "bg-[#181A21] flex flex-col items-center justify-center pt-[20px] ">
        ...
        <div class='border-b-[1.5px] border-[#bababa]'>
            <div class='text-white'>
                © 2025 Valve Corporation. Todos los derechos reservados. Todas las marcas registradas pertenecen a sus respectivos dueños en EE. UU. y otros países.
            </div>
            <div class='text-white flex justify-center pb-[5px]'>
